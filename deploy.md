...
```bash
bash /Users/zztt/projects/26-musiki/scripts/preflight.sh
```
...
```bash
# Saltar build (rápido)
bash /Users/zztt/projects/26-musiki/scripts/preflight.sh --skip-build

# Saltar test de API remota
bash /Users/zztt/projects/26-musiki/scripts/preflight.sh --skip-api

# Usar un env de producción
bash /Users/zztt/projects/26-musiki/scripts/preflight.sh --env-file .env.production
```
