...
export const POST: APIRoute = async ({ request, locals }) => {
  ...
  try {
    ...
    console.log('[API] Request body:', { evalId, answer, isCorrect, courseId, pageSlug });
    ...
    if (!assignment) {
      ...
      // Use courseId and pageSlug from frontend if provided, otherwise fallback
      ...
      console.log('[API] Assignment auto-created:', evalId, 'for course:', finalCourseId, 'slug:', finalSlug);
    }
