...
## Facilitá las cosas a tu futuro yo
...
## Mantené tus ideas en movimiento
...
>  reducir la *complejidad* del mundo para operar con **representaciones**
...
también se enraiza en la idea de abstraer el alma del cuerpo en la transmutación de los cuerpos. 
...
La anotación mental consiste en crear conexiones entre ideas y notas. Hoy nos enfocaremos en cómo usar **Obsidian** para implementar estas técnicas.
...
<img src="https://i.imgur.com/labJYoq.png" style="width:800px;"></img>
...
<font color="#8E44AD">**Escenario:**</font> Estás estudiando para un examen de Instrumentos y quieres retener términos clave y teorías.
### Pasos:
...
1. Usa el plugin **Spaced Repetition** para revisar:
...
- Intentá vincular notas no relacionadas para encontrar conexiones sorprendentes.
...
2. **Vincula tus Notas**:
- Añadí  [[enlaces]] entre al menos 10 notas.

--

3. **Usa Repetición Espaciada**:

- Instalá el plugin y crea 5 tarjetas.

4. **Exploración de Gráfico**:

- Abrí la Vista de Gráfico y comparte tus descubrimientos con el grupo.
