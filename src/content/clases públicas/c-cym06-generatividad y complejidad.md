...
<grid drag="-50 10" drop="0 -8" bg="black">
![|20](https://i.imgur.com/3dKJzNX.png)  
</grid>

<grid drag="0 10" drop="12 -12">
...
---
![](https://i.imgur.com/X8Z1YKl.png)

CAYC

---

![](https://i.imgur.com/ZQH0fAD.png)
...
---
![](https://i.imgur.com/IoEJViz.jpeg)
...
```mermaid
flowchart TB
  Humano -->|colaboración| NoHumano
  Humano --> Agente
  NoHumano --> Agente
  Agente --> Material
  Material -->|dominar| Control
  Material -->|liberar| Descontrol
  Control <--> Descontrol
  Agente --> PuestaEnEscena
  PuestaEnEscena --> Obra
  Obra --> Humano
  Obra --> NoHumano
  Generatividad[Generatividad = regular el procedimiento entre control y descontrol]
  Generatividad --- Control
  Generatividad --- Descontrol
...
![](https://i.imgur.com/p1nWUHb.png)

---


![](https://i.imgur.com/vHh7sbP.png)


---

![](https://i.imgur.com/E0iTRhg.png)
...
```mermaid
flowchart LR
  Mohr[Manfred Mohr] --> HardEdge[Hard edge]
  HardEdge --> Reglas[Reglas y algoritmos]
  Reglas --> Generativo[Arte generativo]
  Mohr --> Ordenador[Ordenador]
  Ordenador --> Plotter[Plotter]
  Plotter --> Generativo
  Sonderborg[KRH Sonderborg] --> Mohr
  Bense[Max Bense info estetica] --> Reglas
  Barbaud[Pierre Barbaud musica por ordenador] --> Reglas
  Jazz[Jazz] --> Reglas
  Serialismo[Musica serial] --> Reglas
  Generativo --> Paris1971[Paris 1971 solo show]
  Generativo --> Cybernetic1968[Cybernetic Serendipity 1968]

  %% wireframe con colores vivos (sin relleno)
  style Mohr fill:none,stroke:#e63946,stroke-width:3px,color:#e63946
  style Sonderborg fill:none,stroke:#e63946,stroke-width:3px,color:#e63946
  style Bense fill:none,stroke:#e63946,stroke-width:3px,color:#e63946
  style Barbaud fill:none,stroke:#e63946,stroke-width:3px,color:#e63946
  style Jazz fill:none,stroke:#e63946,stroke-width:3px,color:#e63946
  style Serialismo fill:none,stroke:#e63946,stroke-width:3px,color:#e63946

  style HardEdge fill:none,stroke:#457b9d,stroke-width:3px,color:#457b9d
  style Reglas fill:none,stroke:#457b9d,stroke-width:3px,color:#457b9d
  style Ordenador fill:none,stroke:#457b9d,stroke-width:3px,color:#457b9d
  style Plotter fill:none,stroke:#457b9d,stroke-width:3px,color:#457b9d

  style Generativo fill:none,stroke:#2a9d8f,stroke-width:3px,color:#2a9d8f
  style Paris1971 fill:none,stroke:#2a9d8f,stroke-width:3px,color:#2a9d8f
  style Cybernetic1968 fill:none,stroke:#2a9d8f,stroke-width:3px,color:#2a9d8f
```
...
```mermaid
flowchart TB
  V[Vertices del cubo] --> E[Aristas con distancia Hamming 1]
  E --> Rot[Rotaciones alpha y beta]
  Rot --> Proj[Proyeccion en perspectiva]
  Proj --> Mask[Mascara binaria m]
  Mask --> Rule[Paridad popcount]
  Rule --> Plot[Trazado plotter]
  Plot --> Obra[Obra resultante]
  Ctrl[Controles alpha m S] --> Rot
  Ctrl --> Mask
  Ctrl --> Proj

  %% mismo wireframe y paleta
  style V fill:none,stroke:#457b9d,stroke-width:3px,color:#457b9d
  style E fill:none,stroke:#457b9d,stroke-width:3px,color:#457b9d
  style Rot fill:none,stroke:#457b9d,stroke-width:3px,color:#457b9d
  style Proj fill:none,stroke:#457b9d,stroke-width:3px,color:#457b9d
  style Plot fill:none,stroke:#457b9d,stroke-width:3px,color:#457b9d
  style Ctrl fill:none,stroke:#457b9d,stroke-width:3px,color:#457b9d

  style Mask fill:none,stroke:#f4a261,stroke-width:3px,color:#f4a261
  style Rule fill:none,stroke:#f4a261,stroke-width:3px,color:#f4a261

  style Obra fill:none,stroke:#2a9d8f,stroke-width:3px,color:#2a9d8f
```
