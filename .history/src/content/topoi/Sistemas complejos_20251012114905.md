...
1. Cantidad de Reglas de interacción
   2. R-pentomino de Game of Life
3. Emergencia como el equilibro entre orden total y caos total (o azar total)
   4. una medida util de complejidad sería cuanto de dificil es un sistema de pronosticar.
5. asi como podemos construir la emergencia de la complejidad, también podemos construir la emergencia de la simplicidad (Thorén y Gerlee, 2010)
6. Dada la complejidad podemos medir sus propiedades (atributos) emergentes.
Un ejemplo:
m x n^2
***
## ESTRATOS
...
## MÉTODO
[A.la](https://a.la) importancia del **BORRADOR**
